...
import { GetByIdSellerGig, ISellerGigGetByIdResult } from '../../../UseCases/4-gig-usecase/get-id.gig.usecase';
import { BadRequestError } from '../../Error/errorInterface';
import { GetSellerGigs, ISellerGigGetBySellerIdResult } from '../../../UseCases/4-gig-usecase/get-sellerId.gig.usecase';
import { GetSellerPausedGigs, ISellerGigGetByPausedGigsResult } from '../../../UseCases/4-gig-usecase/get-paused.gig.usecses';
import {
  MoreLikeThisResult,
  MoreLikeThisUsecase
} from '../../../UseCases/4-gig-usecase/get-MoreGigsLikeThis';

import { GetByCategorySellerGig, ISellerGigGetByCategoryResult } from '../../../UseCases/4-gig-usecase/get-category.gig.usecase';
import { CacheLoginUser, selectedCategory } from '../../../Database/cache/Cache';
