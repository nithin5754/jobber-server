...
import { IMailer, IEmailMessageDetails } from "../../External-libraries/4-mailer/IMailer";
...
export class AuthService implements IAuthService   {
  ...
  uploadsPhotos(file: string, public_id?: string, overWrite?: boolean, invalidate?: boolean): Promise<UploadApiResponse | UploadApiErrorResponse | undefined> {
